...
const SignUp = () => {
  return (
    ...
    >
      ...
      {/* Main Card */}
      <div
        className="relative w-full max-w-[1000px] md:h-[600px] bg-cover bg-center backdrop-blur-sm shadow-2xl rounded-xl flex flex-col-reverse md:flex-row items-center justify-between overflow-hidden mx-4 my-6"
        style={{
          backgroundImage: `url(${background})`,
        }}
      >
        {/* Left Form Section (shows first on desktop, after image on mobile) */}
        ...
        {/* Right Image Section (shows first on mobile, second on desktop) */}
